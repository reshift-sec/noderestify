...
function Step(options) {(0, _classCallCheck3.default)(this, Step);var
  ...
  options.backgroundLines,gherkinData = options.gherkinData,language = options.language,lineToKeywordMapping = options.lineToKeywordMapping,previousStep = options.previousStep,scenario = options.scenario;
