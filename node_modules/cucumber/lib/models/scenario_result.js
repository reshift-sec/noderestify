...
ScenarioResult = function () {
  function ScenarioResult(scenario, status) {(0, _classCallCheck3.default)(this, ScenarioResult);
    this.duration = 0;
    ...
    stepResult) {var
      duration = stepResult.duration,failureException = stepResult.failureException,status = stepResult.status;
      if (duration) {
