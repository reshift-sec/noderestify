...
function Scenario(options) {var _this = this;(0, _classCallCheck3.default)(this, Scenario);var
  ...
  options.backgroundStepLines,feature = options.feature,gherkinData = options.gherkinData,language = options.language,lineToDescriptionMapping = options.lineToDescriptionMapping,stepLineToKeywordMapping = options.stepLineToKeywordMapping;
